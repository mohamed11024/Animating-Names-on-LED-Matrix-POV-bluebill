...
void RCC_voidEnableClock(BUS_ID copy_bus_id , Peripheral_t copy_periphiral_id){
...
void RCC_voidDisableClock(BUS_ID copy_bus_id , Peripheral_t copy_periphiral_id){
    if (copy_periphiral_id <= 31){
        switch (copy_bus_id)
        {
        case t_AHB:
